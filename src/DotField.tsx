...
// DotField - 基于 React Bits 改造
// 原作者: DavidHDev (https://reactbits.dev/backgrounds/dot-field)
// 适配 SubmitGuard 主题配色
const DotField = memo(() => {
  // 主题配色
  const dotRadius = 2.5
  ...
  // coral / lilac 渐变 - 加深透明度
  const gradientFrom = 'rgba(255, 137, 111, 0.8)'
  const gradientTo = 'rgba(217, 184, 255, 0.7)'
